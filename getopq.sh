...
then
    curl -O https://files.gitter.im/5f27939ed73408ce4feb3112/iVdb/OPQBot_6.0.12_linux_arm.tar.gz
    tar -xvf OPQBot_6.0.12_linux_arm.tar.gz
    mv OPQBot_6.0.12_linux_arm OPQBot
elif [[ "$platform" = "linux/arm64" ]]
then
    curl -O https://files.gitter.im/5f27939ed73408ce4feb3112/iVdb/OPQBot_6.0.12_linux_arm64.tar.gz
    tar -xvf OPQBot_6.0.12_linux_arm64.tar.gz
